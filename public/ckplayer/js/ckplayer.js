...
(function (global, factory) {
  ...
  var language = {
    ...
    smallwindows:
      "%E5%B0%8F%E7%AA%97%E5%8F%A3%E6%92%AD%E6%94%BE%E5%8A%9F%E8%83%BD",
    ...
    closeTime:
      "%7Bseconds%7D%E7%A7%92%E5%90%8E%E5%8F%AF%E5%85%B3%E9%97%AD%E5%B9%BF%E5%91%8A",
    closeAd: "%E5%85%B3%E9%97%AD%E5%B9%BF%E5%91%8A",
    second: "%E7%A7%92",
    details: "%E6%9F%A5%E7%9C%8B%E8%AF%A6%E6%83%85",
    copy: "%E5%A4%8D%E5%88%B6",
    copySucceeded:
      "%E5%A4%8D%E5%88%B6%E6%88%90%E5%8A%9F%EF%BC%8C%E5%8F%AF%E8%B4%B4%E7%B2%98%EF%BC%81",
    smallwindowsOpen:
      "%E5%B0%8F%E7%AA%97%E5%8F%A3%E5%8A%9F%E8%83%BD%E5%B7%B2%E5%BC%80%E5%90%AF",
    smallwindowsClose:
      "%E5%B0%8F%E7%AA%97%E5%8F%A3%E5%8A%9F%E8%83%BD%E5%B7%B2%E5%85%B3%E9%97%AD",
    screenshotStart:
      "%E6%88%AA%E5%9B%BE%E4%B8%AD%EF%BC%8C%E8%AF%B7%E7%A8%8D%E5%80%99...",
    screenshotClose:
      "%E6%88%AA%E5%9B%BE%E5%8A%9F%E8%83%BD%E5%B7%B2%E5%85%B3%E9%97%AD",
    loopOpen: "%E5%BE%AA%E7%8E%AF%E6%92%AD%E6%94%BE",
    loopClose:
      "%E5%B7%B2%E5%85%B3%E9%97%AD%E5%BE%AA%E7%8E%AF%E6%92%AD%E6%94%BE",
    ...
    timeScheduleAdjust: {
      ...
      prohibitBackOff:
        "%E8%A7%86%E9%A2%91%E7%A6%81%E6%AD%A2%E9%87%8D%E5%A4%8D%E8%A7%82%E7%9C%8B",
      prohibitForward: "%E8%A7%86%E9%A2%91%E7%A6%81%E6%AD%A2%E5%BF%AB%E8%BF%9B",
      prohibitLookBack:
        "%E8%A7%86%E9%A2%91%E7%A6%81%E6%AD%A2%E6%92%AD%E6%94%BE%E9%83%A8%E5%88%86%E5%86%85%E5%AE%B9",
      prohibitForwardNotViewed:
        "%E8%A7%86%E9%A2%91%E7%A6%81%E6%AD%A2%E6%92%AD%E6%94%BE%E6%9C%AA%E8%A7%82%E7%9C%8B%E7%9A%84%E9%83%A8%E5%88%86",
    },
    error: {
      noMessage: "%E6%9C%AA%E7%9F%A5%E9%94%99%E8%AF%AF",
      supportVideoError:
        "%E8%AF%A5%E6%B5%8F%E8%A7%88%E5%99%A8%E7%89%88%E6%9C%AC%E5%A4%AA%E4%BD%8E%EF%BC%8C%E5%BB%BA%E8%AE%AE%E6%9B%B4%E6%8D%A2%E6%88%90%E5%85%B6%E5%AE%83%E6%B5%8F%E8%A7%88%E5%99%A8",
      videoTypeError:
        "%E8%AF%A5%E6%B5%8F%E8%A7%88%E5%99%A8%E4%B8%8D%E6%94%AF%E6%8C%81%E6%92%AD%E6%94%BE%E8%AF%A5%E8%A7%86%E9%A2%91%EF%BC%8C%E5%BB%BA%E8%AE%AE%E6%9B%B4%E6%8D%A2%E6%88%90%E5%85%B6%E5%AE%83%E6%B5%8F%E8%A7%88%E5%99%A8",
      loadingFailed: "%E5%8A%A0%E8%BD%BD%E5%A4%B1%E8%B4%A5",
      emptied:
        "%E8%A7%86%E9%A2%91%E6%96%87%E4%BB%B6%E5%8A%A0%E8%BD%BD%E8%BF%87%E7%A8%8B%E4%B8%AD%E5%87%BA%E7%8E%B0%E9%94%99%E8%AF%AF",
      ...
      noVideoContainer:
        "%E6%9C%AA%E6%89%BE%E5%88%B0%E6%94%BE%E7%BD%AE%E8%A7%86%E9%A2%91%E7%9A%84%E5%AE%B9%E5%99%A8",
    },
  };
  /*
   * videoObjectDefault
  ...
  function ckplayerEmbed(videoObj) {
    ...
    var into = function (obj) {
        ...
        if (
          valType(obj) == "string" &&
          (obj.substr(0, 8) == "website:" || obj.substr(0, 4) == "url:")
        ) {
          var ajaxUrl = "";
          ...
          if (!isUndefined(obj["container"]) && obj["container"]) {
            ...
            if (CT) {
              ...
              //如果播放容器不存在，则则等页面加载完成后运行
              return bodyReady(obj);
            }
          } else {
            //不存在播放容器配置则等页面加载完成后运行
            return bodyReady(obj);
          }
        } else {
      ...
      ajaxWebsite = function (obj) {
        if (
          valType(obj["video"]) == "string" &&
          (obj["video"].substr(0, 8) == "website:" ||
            obj["video"].substr(0, 4) == "url:")
        ) {
      ...
      embed = function (obj) {
         ...
         */
        if (
          valType(vars["video"]) == "string" &&
          ((vars["video"].substr(0, 1) == "." &&
            vars["video"].indexOf("/") == -1) ||
            vars["video"].substr(0, 1) == "#")
        ) {
          video = $(vars["video"]);
        }
        ...
        if (isUndefined(video.canPlayType)) {
          CT.error = {
            code: 5,
            message: language["error"]["supportVideoError"],
          };
      ...
      changeVideo = function (vstr) {
        ...
        if (
          !isUndefined(video.find("source")) &&
          video.find("source").length > 0
        ) {
          video
            .find("source")
            .eq(video.find("source").length - 1)
            .addListener("error", videoHandler.error);
        }
        checkBar();
        loadLogo();
        if (isChangeDef) {
        ...
        if (vars["cookie"]) {
          if (
            valType(vars["cookie"]) == "array" &&
            vars["cookie"].length >= 2
          ) {
          ...
          if (
            valType(vars["cookie"]) == "object" &&
            !isUndefined(vars["cookie"]["name"])
          ) {
            cookieName = vars["cookie"]["name"];
            if (
              !isUndefined(vars["cookie"]["hour"]) &&
              valType(vars["cookie"]["hour"]) == "number"
            ) {
      ...
      loadFace = function () {
        ...
        C["bar"]["pbox"]
          .append(C["bar"]["pbox"]["bg"])
          .append(C["bar"]["pbox"]["slider"]);
        ...
        if (valType(vars["live"]) == "number") {
          ...
          C["bar"]["pbox"]["slider"].css({
            left:
              100 -
              (C["bar"]["pbox"]["slider"].getWidth() * 100) /
                C["bar"]["pbox"]["bg"].getWidth() +
              "%",
          });
        }
        //播放暂停按钮组
        ...
        C["bar"]["playAndPause"]["play"] = createlButton(
          "ck-bar-btn ck-btn-play"
        );
        C["bar"]["playAndPause"]["play"].click(player.play);
        C["bar"]["playAndPause"]["play"].mouseover(function () {
          tip(this, language["play"]);
        });
        C["bar"]["playAndPause"].append(C["bar"]["playAndPause"]["play"]);

        C["bar"]["playAndPause"]["pause"] = createlButton(
          "ck-bar-btn ck-btn-pause"
        );
        C["bar"]["playAndPause"]["pause"].click(player.pause);
        C["bar"]["playAndPause"]["pause"].mouseover(function () {
          tip(this, language["pause"]);
        });
        C["bar"]["playAndPause"].append(C["bar"]["playAndPause"]["pause"]);
        C["bar"]["playAndPause"]["pause"].hide();
        C["bar"]["playAndPause"]["refresh"] = createlButton(
          "ck-bar-btn ck-btn-refresh"
        );
        C["bar"]["playAndPause"]["refresh"].click(player.play);
        C["bar"]["playAndPause"]["refresh"].mouseover(function () {
          tip(this, language["refresh"]);
        });
        ...
        //时间显示框
        var timeDefault =
          formatSeconds(player.time()) + "/" + formatSeconds(duration);
        if (vars["live"]) {
        ...
        C["bar"]["fullAndExit"]["full"] = createlButton(
          "ck-bar-btn ck-btn-full"
        );
        C["bar"]["fullAndExit"]["full"].click(player.fullOrExit);
        C["bar"]["fullAndExit"]["full"].mouseover(function () {
          tip(this, language["full"]);
        });
        C["bar"]["fullAndExit"].append(C["bar"]["fullAndExit"]["full"]);

        C["bar"]["fullAndExit"]["exitFull"] = createlButton(
          "ck-bar-btn ck-btn-exitfull"
        );
        C["bar"]["fullAndExit"]["exitFull"].click(player.fullOrExit);
        C["bar"]["fullAndExit"]["exitFull"].mouseover(function () {
          tip(this, language["exitFull"]);
        });
        ...
        C["bar"]["webFullAndExit"]["webFull"] = createlButton(
          "ck-bar-btn ck-btn-webfull"
        );
        C["bar"]["webFullAndExit"]["webFull"].click(player.webFull);
        C["bar"]["webFullAndExit"]["webFull"].mouseover(function () {
          tip(this, language["webFull"]);
        });
        C["bar"]["webFullAndExit"].append(
          C["bar"]["webFullAndExit"]["webFull"]
        );

        C["bar"]["webFullAndExit"]["exitWebFull"] = createlButton(
          "ck-bar-btn ck-btn-exitwebfull"
        );
        C["bar"]["webFullAndExit"]["exitWebFull"].click(player.exitWebFull);
        C["bar"]["webFullAndExit"]["exitWebFull"].mouseover(function () {
          tip(this, language["exitWebFull"]);
        });
        C["bar"]["webFullAndExit"].append(
          C["bar"]["webFullAndExit"]["exitWebFull"]
        );
        if (!vars["webFull"]) {
        ...
        C["bar"]["theatreAndExit"]["theatre"] = createlButton(
          "ck-bar-btn ck-btn-theatre"
        );
        C["bar"]["theatreAndExit"]["theatre"].click(player.theatre);
        C["bar"]["theatreAndExit"]["theatre"].mouseover(function () {
          tip(this, language["theatre"]);
        });
        C["bar"]["theatreAndExit"].append(
          C["bar"]["theatreAndExit"]["theatre"]
        );

        C["bar"]["theatreAndExit"]["exitTheatre"] = createlButton(
          "ck-bar-btn ck-btn-exittheatre"
        );
        C["bar"]["theatreAndExit"]["exitTheatre"].click(player.exitTheatre);
        C["bar"]["theatreAndExit"]["exitTheatre"].mouseover(function () {
          tip(this, language["exitTheatre"]);
        });
        C["bar"]["theatreAndExit"].append(
          C["bar"]["theatreAndExit"]["exitTheatre"]
        );
        ...
        C["bar"]["vbox"]["exitMuted"] = createlButton(
          "ck-bar-btn ck-btn-exitmuted"
        );
        ...
        C["bar"]["vbox"]["volume"]["txt"] = createlDiv(
          "ck-bar-volume-txt",
          "0"
        );
        C["bar"]["vbox"]["volume"]["box"].append(
          C["bar"]["vbox"]["volume"]["txt"]
        );
        C["bar"]["vbox"]["volume"]["bg"] = createlDiv("ck-bar-volume-bg");
        C["bar"]["vbox"]["volume"]["box"].append(
          C["bar"]["vbox"]["volume"]["bg"]
        );
        C["bar"]["vbox"]["volume"]["pp"] = createlDiv("ck-bar-volume-pp");
        C["bar"]["vbox"]["volume"]["bg"].append(
          C["bar"]["vbox"]["volume"]["pp"]
        );
        C["bar"]["vbox"]["volume"]["slider"] = createlDiv(
          "ck-bar-volume-slider"
        );
        C["bar"]["vbox"]["volume"]["box"].append(
          C["bar"]["vbox"]["volume"]["slider"]
        );
        ...
        C["bar"]["vbox"].mouseover(function () {
          changeVolumeSlider(video.muted ? 0 : video.volume);
        });
        //播速容器
        C["bar"]["playbackrate"] = createlDiv("ck-bar-playbackrate-box");
        C["bar"].append(C["bar"]["playbackrate"]);
        C["bar"]["playbackrate"]["button"] = createlDiv(
          "ck-bar-playbackrate",
          language["playbackrate"]
        );
        C["bar"]["playbackrate"].append(C["bar"]["playbackrate"]["button"]);
        C["bar"]["playbackrate"]["bgbox"] = createlDiv(
          "ck-bar-playbackrate-bg-box ck-list-bg-box"
        );
        ...
        C["bar"]["track"]["button"] = createlDiv(
          "ck-bar-track",
          language["track"]
        );
        C["bar"]["track"].append(C["bar"]["track"]["button"]);
        C["bar"]["track"]["bgbox"] = createlDiv(
          "ck-bar-track-bg-box ck-list-bg-box"
        );
        ...
        C["bar"]["definition"]["button"] = createlDiv(
          "ck-bar-definition",
          language["definition"]
        );
        C["bar"]["definition"].append(C["bar"]["definition"]["button"]);
        C["bar"]["definition"]["bgbox"] = createlDiv(
          "ck-bar-definition-bg-box ck-list-bg-box"
        );
        C["bar"]["definition"].append(C["bar"]["definition"]["bgbox"]);
        C["bar"]["definition"].hide();
        //截图按钮
        C["rightBar"]["screenshot"] = createlButton(
          "ck-bar-btn ck-btn-screenshot"
        );
        C["rightBar"].append(C["rightBar"]["screenshot"]);
        C["rightBar"]["screenshot"].mouseover(function () {
          tip(this, language["screenshot"], null, "left");
        });
        ...
        C["rightBar"]["smallwindows"]["open"] = createlButton(
          "ck-bar-btn ck-btn-smallwindows-open"
        );
        C["rightBar"]["smallwindows"]["open"].click(function () {
          tip(this, language["smallwindowsClose"], null, "left");
          player.smallWindows(false);
        });
        C["rightBar"]["smallwindows"]["open"].mouseover(function () {
          tip(this, language["smallwindowsOpen"], null, "left");
        });
        C["rightBar"]["smallwindows"].append(
          C["rightBar"]["smallwindows"]["open"]
        );

        C["rightBar"]["smallwindows"]["close"] = createlButton(
          "ck-bar-btn ck-btn-smallwindows-close"
        );
        C["rightBar"]["smallwindows"]["close"].click(function () {
          tip(this, language["smallwindowsOpen"], null, "left");
          player.smallWindows(true);
        });
        C["rightBar"]["smallwindows"]["close"].mouseover(function () {
          tip(this, language["smallwindowsClose"], null, "left");
        });
        C["rightBar"]["smallwindows"].append(
          C["rightBar"]["smallwindows"]["close"]
        );
        //循环按钮组
        C["rightBar"]["loop"] = createlDiv("ck-right-bar-loop");
        C["rightBar"].append(C["rightBar"]["loop"]);

        C["rightBar"]["loop"]["open"] = createlButton(
          "ck-bar-btn ck-btn-loop-open"
        );
        C["rightBar"]["loop"]["open"].click(function () {
          tip(this, language["loopClose"], null, "left");
          player.loop(false);
        });
        C["rightBar"]["loop"]["open"].mouseover(function () {
          tip(this, language["loopOpen"], null, "left");
        });
        C["rightBar"]["loop"].append(C["rightBar"]["loop"]["open"]);

        C["rightBar"]["loop"]["close"] = createlButton(
          "ck-bar-btn ck-btn-loop-close"
        );
        C["rightBar"]["loop"]["close"].click(function () {
          tip(this, language["loopOpen"], null, "left");
          player.loop(true);
        });
        C["rightBar"]["loop"]["close"].mouseover(function () {
          tip(this, language["loopClose"], null, "left");
        });
        ...
        C["screenshot"]["bar"]["down"] = createlA(
          language["down"],
          "",
          "ck-screenshot-btn ck-screenshot-down"
        );
        C["screenshot"]["bar"].append(C["screenshot"]["bar"]["down"]);

        C["screenshot"]["bar"]["close"] = createlButton(
          "ck-screenshot-btn ck-screenshot-close",
          language["close"]
        );
        ...
        C["topBar"]["zoomEle"]["zoom50"] = createlDiv(
          "ck-top-bar-zoom-container"
        );
        C["topBar"]["zoomEle"].append(C["topBar"]["zoomEle"]["zoom50"]);
        C["topBar"]["zoomEle"]["zoom50"]["left"] = createlDiv(
          "ck-top-bar-zoom-left"
        );
        C["topBar"]["zoomEle"]["zoom50"].append(
          C["topBar"]["zoomEle"]["zoom50"]["left"]
        );
        C["topBar"]["zoomEle"]["zoom50"]["left"]["button"] = createlDiv(
          "ck-top-bar-zoom-button-50"
        );
        C["topBar"]["zoomEle"]["zoom50"]["left"].append(
          C["topBar"]["zoomEle"]["zoom50"]["left"]["button"]
        );
        C["topBar"]["zoomEle"]["zoom50"]["right"] = createlDiv(
          "ck-top-bar-zoom-right",
          language["p50"]
        );
        C["topBar"]["zoomEle"]["zoom50"].append(
          C["topBar"]["zoomEle"]["zoom50"]["right"]
        );
        C["topBar"]["zoomEle"]["zoom50"].click(function () {
          player.zoom(50);
        });

        C["topBar"]["zoomEle"]["zoom75"] = createlDiv(
          "ck-top-bar-zoom-container"
        );
        C["topBar"]["zoomEle"].append(C["topBar"]["zoomEle"]["zoom75"]);
        C["topBar"]["zoomEle"]["zoom75"]["left"] = createlDiv(
          "ck-top-bar-zoom-left"
        );
        C["topBar"]["zoomEle"]["zoom75"].append(
          C["topBar"]["zoomEle"]["zoom75"]["left"]
        );
        C["topBar"]["zoomEle"]["zoom75"]["left"]["button"] = createlDiv(
          "ck-top-bar-zoom-button-75"
        );
        C["topBar"]["zoomEle"]["zoom75"]["left"].append(
          C["topBar"]["zoomEle"]["zoom75"]["left"]["button"]
        );
        C["topBar"]["zoomEle"]["zoom75"]["right"] = createlDiv(
          "ck-top-bar-zoom-right",
          language["p75"]
        );
        C["topBar"]["zoomEle"]["zoom75"].append(
          C["topBar"]["zoomEle"]["zoom75"]["right"]
        );
        C["topBar"]["zoomEle"]["zoom75"].click(function () {
          player.zoom(75);
        });

        C["topBar"]["zoomEle"]["zoom100"] = createlDiv(
          "ck-top-bar-zoom-container"
        );
        C["topBar"]["zoomEle"].append(C["topBar"]["zoomEle"]["zoom100"]);
        C["topBar"]["zoomEle"]["zoom100"]["left"] = createlDiv(
          "ck-top-bar-zoom-left"
        );
        C["topBar"]["zoomEle"]["zoom100"].append(
          C["topBar"]["zoomEle"]["zoom100"]["left"]
        );
        C["topBar"]["zoomEle"]["zoom100"]["left"]["button"] = createlDiv(
          "ck-top-bar-zoom-button-100"
        );
        C["topBar"]["zoomEle"]["zoom100"]["left"].append(
          C["topBar"]["zoomEle"]["zoom100"]["left"]["button"]
        );
        C["topBar"]["zoomEle"]["zoom100"]["right"] = createlDiv(
          "ck-top-bar-zoom-right",
          language["p100"]
        );
        C["topBar"]["zoomEle"]["zoom100"].append(
          C["topBar"]["zoomEle"]["zoom100"]["right"]
        );
        C["topBar"]["zoomEle"]["zoom100"].click(function () {
          player.zoom(100);
        });
        ...
        C["ad"]["bottom"]["fullAndExit"]["full"] = createlButton(
          "ck-yytf-btn ck-yytf-fullandexit-full"
        );
        C["ad"]["bottom"]["fullAndExit"]["full"].click(player.full);
        C["ad"]["bottom"]["fullAndExit"].append(
          C["ad"]["bottom"]["fullAndExit"]["full"]
        );
        C["ad"]["bottom"]["fullAndExit"]["exitFull"] = createlButton(
          "ck-yytf-btn ck-yytf-fullandexit-exitfull"
        );
        C["ad"]["bottom"]["fullAndExit"].append(
          C["ad"]["bottom"]["fullAndExit"]["exitFull"]
        );
        ...
        C["ad"]["bottom"]["mutedAndExit"]["muted"] = createlButton(
          "ck-yytf-btn ck-yytf-mutedandexit-muted"
        );
        C["ad"]["bottom"]["mutedAndExit"].append(
          C["ad"]["bottom"]["mutedAndExit"]["muted"]
        );
        C["ad"]["bottom"]["mutedAndExit"]["muted"].click(player.muted);
        C["ad"]["bottom"]["mutedAndExit"]["exitMuted"] = createlButton(
          "ck-yytf-btn ck-yytf-mutedandexit-exitmuted"
        );
        C["ad"]["bottom"]["mutedAndExit"].append(
          C["ad"]["bottom"]["mutedAndExit"]["exitMuted"]
        );
        C["ad"]["bottom"]["mutedAndExit"]["exitMuted"].click(player.exitMuted);

        C["ad"]["bottom"]["details"] = createlDiv(
          "ck-yytf-details",
          language["details"]
        );
        ...
        C["about"]["bar"]["copy"] = createlButton(
          "ck-bar-btn ck-btn-about-copy"
        );
        C["about"]["bar"].append(C["about"]["bar"]["copy"]);
        C["about"]["bar"]["copy"].click(aboutCopy);
        C["about"]["bar"]["copy"].mouseover(function () {
          tip(this, language["copy"], null, "left");
        });

        C["about"]["bar"]["close"] = createlButton(
          "ck-bar-btn ck-btn-about-close"
        );
        C["about"]["bar"]["close"].click(aboutHide);
        C["about"]["bar"]["close"].mouseover(function () {
          tip(this, language["close"], null, "left");
        });
      ...
      addAllListener = function () {
        ...
        if (!isUndefined(vars["smallWindows"])) {
          if (
            valType(vars["smallWindows"]) == "boolean" &&
            vars["smallWindows"]
          ) {
            addListener(
      ...
      loadTrack = function () {
        ...
        var i = 0;
        if (
          !isUndefined(vars["track"]) &&
          valType(vars["track"]) == "array" &&
          !video.find("track")
        ) {
          var track = "";
          var arr = vars["track"];
    ...
    var videoHandler = {
      ...
      loadedMetaData: function () {
        ...
        if (!vars["live"]) {
          C["time"].htm(
            formatSeconds(this.currentTime) + "/" + formatSeconds(duration)
          );
          C["tempTime"].htm(
            formatSeconds(this.currentTime) + "/" + formatSeconds(duration)
          );
        ...
        if (
          !isUndefined(vars["prompt"]) &&
          valType(vars["prompt"]) == "array" &&
          !vars["live"]
        ) {
          changePrompt();
        } else {
      ...
      timeUpDate: function () {
        ...
        if (!vars["live"]) {
          C["time"].htm(
            formatSeconds(playTime) + "/" + formatSeconds(duration)
          );
          C["tempTime"].htm(
            formatSeconds(playTime) + "/" + formatSeconds(duration)
          );
        ...
        replaceInformation(
          ...
          this.webkitAudioDecodedByteCount || this.audioDecodedByteCount || 0
        );
        replaceInformation(
          "videoDecodedByteCount",
          this.webkitVideoDecodedByteCount || this.videoDecodedByteCount || 0
        );
      },
      ended: function () {
        //监听播放结束
      ...
      seeking: function () {
        ...
        switch (vars["timeScheduleAdjust"]) {
          ...
          case 5: //看过的地方可以随意拖动
            if (seekingTime > maxSeeTime) {
              ...
              message(
                language["timeScheduleAdjust"]["prohibitForwardNotViewed"]
              );
              return;
            }
            break;
        ...
        if (!vars["live"]) {
          C["time"].htm(
            formatSeconds(seekingTime) + "/" + formatSeconds(duration)
          );
          C["tempTime"].htm(
            formatSeconds(seekingTime) + "/" + formatSeconds(duration)
          );
      ...
      play: function () {
        ...
        if (
          seekTime &&
          (isUndefined(vars["live"]) ||
            (!isUndefined(vars["live"]) &&
              valType(vars["live"]) == "boolean" &&
              !vars["live"])) &&
          seekTime < parseInt(duration * 100) * 0.01
        ) {
          //如果默认需要跳转，则进行seek
      ...
      pause: function () {
        ...
        if (
          isUndefined(ad) ||
          isUndefined(ad["frontPlay"]) ||
          (!isUndefined(ad["frontPlay"]) && !ad["frontPlay"])
        ) {
          //如果是贴片广告播放中，则进行播放和计算
          if (!isUndefined(ad) && !isUndefined(ad["pause"])) {
            if (isUndefined(ad["pausePlayI"])) {
              //如果贴片广告还未播放
              ad["pausePlayI"] = 0;
            }
            adPausePlay(); //播放暂停广告
      ...
      keydown: function (event) {
        ...
        switch (keycode) {
          ...
          case 38:
            if (
              valType(vars["keyVolume"]) == "number" &&
              (vars["keyVolume"] == 1 || (vars["keyVolume"] == 2 && CT.full))
            ) {
              pre();
              player.volume(v + 0.1 < 1 ? (v += 0.1) : 1);
            }
            break;
          case 40:
            if (
      ...
      mouseWheel: function (event) {
        if (
          valType(vars["mouseWheelVolume"]) == "number" &&
          (vars["mouseWheelVolume"] == 1 ||
            (vars["mouseWheelVolume"] == 2 && CT.full))
        ) {
          event = window.event || event;
          var v = player.volume();
          if (event.preventDefault) {
    ...
    var adFrontPlay = function () {
      ...
      calculationAdFrontTime = function (t) {
        ...
        C["ad"]["top"]["countDown"].htm(
          ad["front"]["countDown"] + language["second"]
        );
      },
      /*
       * clearAdFrontSetTime
      ...
      closeFrontAd = function () {
        if (
          !isUndefined(ad) &&
          !isUndefined(ad["front"]) &&
          !isUndefined(ad["front"]["closeButtonClick"])
        ) {
      ...
      adPausePlay = function () {
        ...
        if (
          !isUndefined(ad) &&
          !isUndefined(ad["pause"]) &&
          !isUndefined(ad["pause"]["list"]) &&
          ad["pause"]["list"].length - 1 >= ad["pausePlayI"]
        ) {
    ...
    var player = {
      ...
      zoom: function (fn) {
        if (!isUndefined(fn)) {
          ...
          if (valType(fn) == "number") {
            var arr = [
              C["topBar"]["zoomEle"]["zoom50"],
              C["topBar"]["zoomEle"]["zoom75"],
              C["topBar"]["zoomEle"]["zoom100"],
            ];
            for (var i = 0; i < arr.length; i++) {
      ...
      play: function (fn) {
        if (valType(fn) == "object") {
          if (
            fn["target"] == C["bar"]["playAndPause"]["play"] ||
            fn["target"] == C["bar"]["playAndPause"]["refresh"]
          ) {
            playType = "button";
          }
        }
      ...
      exitMuted: function () {
        if (video) {
          video.muted = false;
          if (video.volume == 0) {
            player.volume(vars["volume"] > 0 ? vars["volume"] : 0.8);
          }
        }
        return player;
      },
      ...
      full: function (fn) {
        if (!isUndefined(fn) && valType(fn) == "function") {
          ...
          if (!isUndefined(requestMethod)) {
            ...
            !isUndefined(video.webkitEnterFullscreen) ||
            !isUndefined(video.webkitEnterFullScreen)
          ) {
            var fullScreen =
      ...
      theatre: function (fn) {
        if (!isUndefined(fn) && valType(fn) == "function") {
          ...
          if (
            valType(vars["theatre"]) == "array" &&
            vars["theatre"].length == 2
          ) {
    ...
    var checkBar = function () {
      ...
      loadAbout = function () {
        if (
          !isUndefined(vars["information"]) &&
          !isUndefined(C["about"]) &&
          valType(vars["information"]) == "object"
        ) {
      ...
      loadMenu = function () {
        ...
        let menu = document.querySelector(".ckplayer-ckplayer-menu");
        if (!menu) {
        ...
        let ckli = document.querySelector(".ck-li");
        if (!ckli) {
      ...
      checkPlaybackrate = function () {
        ...
        C["bar"]["playbackrate"]["bgbox"].append(
          C["bar"]["playbackrate"]["bg"]
        );
        C["bar"]["playbackrate"]["bg"]["p"] = [];
        for (var i = playbackrate.length - 1; i > -1; i--) {
          var pTemp = createlButton(
            "ck-list-p",
            playbackrate[i] + language["playbackrateSuffix"]
          );
        ...
        if (
          !isUndefined(vars["playbackrateOpen"]) &&
          vars["playbackrateOpen"]
        ) {
      ...
      playbackrateClick = function (e) {
        ...
        setTimeout(function () {
          C["bar"]["playbackrate"]["bgbox"].removeCss("display");
        }, 300);
      ...
      trackClick = function (e) {
        ...
        setTimeout(function () {
          C["bar"]["track"]["bgbox"].removeCss("display");
        }, 300);
      ...
      checkDefinition = function () {
        ...
        if (valType(vars["video"]) == "array") {
          ...
          for (var i = arr.length - 1; i > -1; i--) {
            ...
            pTemp
              .attr("data-i", i)
              .attr("data-video", arr[i][0])
              .attr("data-type", arr[i][1])
              .attr("data-title", arr[i][2]);
      ...
      showPromptWords = function (ele) {
        ...
        if (!isUndefined(C["preview"])) {
          top =
            ...
            parseFloat(
              getBarHeight() +
                C["preview"]["smallHight"] +
                parseInt(C["preview"].css("margin-bottom"))
            );
        } else {
          top =
            CK.getHeight() -
            parseFloat(
              getBarHeight() +
                C["tip"]["minHeight"] +
                parseInt(C["tip"].css("margin-bottom"))
            );
        ...
        if (!isUndefined(preview)) {
          ...
          var loadImg = function (bigW, bigH, smallW, smallH) {
            ...
            if (vars["preview"]["type"] == 1) {
              ...
              C["preview"]["frame"].css({
                ...
                height:
                  smallH -
                  parseFloat(C["preview"]["frame"].css("border-width")) * 2 +
                  "px",
              });
            }
          };
          if (valType(vars["preview"]) == "object") {
            if (valType(vars["preview"]["file"]) == "array") {
              ...
              var thumbnail = [10, 10];
              if (
                valType(vars["preview"]["thumbnail"]) == "array" &&
                vars["preview"]["thumbnail"].length > 1
              ) {
              ...
              if (files[0]) {
                var img = createlImg(
                  ...
                  loadImg(
                    this.getWidth(),
                    this.getHeight(),
                    this.getWidth() / thumbnail[0],
                    this.getHeight() / thumbnail[1]
                  );
                  this.remove();
                });
                CM.append(img);
      ...
      showPreview = function (time) {
        ...
        if (
          !isUndefined(C["preview"]) &&
          !isUndefined(vars["preview"]["thumbnail"]) &&
          duration > 0
        ) {
          if (isUndefined(vars["preview"]["type"])) {
            vars["preview"]["type"] = 0;
          ...
          var bgXw =
            (time * C["bar"]["pbox"]["bg"].getWidth()) / duration +
            (C["bar"]["pbox"]["bg"].offset()["left"] - CK.offset()["left"]);
          ...
          if (vars["preview"]["type"] == 1) {
            ...
            for (var i = minI; i < maxI; i++) {
              if (C["preview"]["bg"]["img"][i].attr("data-img")) {
                var bgPosition = C["preview"]["bg"]["img"][i].css(
                  "background-position"
                );
                C["preview"]["bg"]["img"][i].css({
                  background:
                    "url(" +
            ...
            frameLeft = bgXw - pW * 0.5;
            left = -(imgI * smallW + smallW * 0.5) + bgXw;
            if (frameLeft < 0) {
              frameLeft = 0;
              bgXw = (pW - smallW) * 0.5;
            ...
            if (
              frameLeft >
              C["preview"].getWidth() - C["preview"]["frame"].getWidth()
            ) {
              var xz =
                frameLeft -
                (C["preview"].getWidth() - C["preview"]["frame"].getWidth());
            ...
            C["preview"].css({
              ...
              "background-position":
                "-" + column * smallW + "px -" + rows * smallH + "px",
              left: left + "px",
            });
          }
        }
      ...
      message = function (str, right) {
        ...
        var msgHide = function () {
          C["message"]
            .removeClass("ck-message-right")
            .removeClass("ck-animate-bouncein")
            .removeClass("ck-animate");
          C["message"].hide();
        };
        if (str) {
          C["message"].htm(str);
      ...
      tip = function (ele, str, cl, align) {
        ...
        if (str) {
          ...
          if (align == "left") {
            C["tip"]["content"]
              .removeClass("ck-content-float-auto")
              .addClass("ck-content-float-left");
            C["tip"]["triangle"]
              .removeClass("ck-triangle-auto")
              .addClass("ck-triangle-left");
          } else {
            C["tip"]["content"]
              .removeClass("ck-content-float-left")
              .addClass("ck-content-float-auto");
            C["tip"]["triangle"]
              .removeClass("ck-triangle-left")
              .addClass("ck-triangle-auto");
          }
      ...
      tipResize = function (ele, cl, align) {
        ...
        if (w > ew) {
          left = offset["left"] - ckOffset["left"] - (w - ew) * 0.5;
        } else {
          left = offset["left"] - ckOffset["left"] + (ew - w) * 0.5;
        }
        if (align == "left") {
      ...
      progressDragX = function () {
        ...
        var sliderMouseDown = function (e) {
          ...
          sliderDownTime =
            (left * duration) / (bg.getWidth() - slider.getWidth());
        ...
        var docMouseMove = function (e) {
          ...
          if (!vars["live"]) {
            ...
            time = formatLiveTime(
              (left * getLiveTime()) / (bg.getWidth() - slider.getWidth())
            );
          }
          tip(slider, time);
          if (left >= 0) {
            ...
            play.css({
              width: left + slider.getWidth() * 0.5 + "px",
            });
          } else {
            pSliderMouseDown = false;
          }
        ...
        var docMouseUp = function () {
          ...
          if (!vars["live"]) {
            var time =
              (play.getWidth() * duration) /
              (bg.getWidth() - slider.getWidth() * 0.5);
            if (time > duration) {
              time = duration;
            }
            seekTime = 0;
            ...
            var playbackTime = parseInt(
              vars["live"] +
                (play.getWidth() * getLiveTime()) /
                  (bg.getWidth() - slider.getWidth() * 0.5)
            );
            eventTarget("playback", {
              time: playbackTime,
              date: date("Y-m-d H:i:s", playbackTime),
            });
            eventTarget("seek", {
              time: playbackTime,
              state: "seeking",
        ...
        var sliderMouseOver = function () {
          ...
          if (!vars["live"]) {
            time = formatSeconds(
              (parseInt(slider.css("left")) * duration) /
                (bg.getWidth() - slider.getWidth())
            );
          } else {
            time = language["live"];
          }
        ...
        var bgMouseDown = function (e) {
          ...
          if (!vars["live"]) {
            ...
            var playbackTime = parseInt(
              vars["live"] + (getLiveTime() * w) / bg.getWidth()
            );
            eventTarget("playback", {
              time: playbackTime,
              date: date("Y-m-d H:i:s", playbackTime),
          ...
          if (w > bg.getWidth() - slider.getWidth() * 0.5) {
            w = bg.getWidth() - slider.getWidth() * 0.5;
          }
          if (w < slider.getWidth() * 0.5) {
            w = slider.getWidth() * 0.5;
          }
          pSliderMouseDown = true;
          play.css({
            width: w + "px",
        ...
        var bgMouseMove = function (e) {
          ...
          tip(bg, time, client);
          mouseLine.css({
            left: w - C["bar"]["pbox"]["mouseLine"].getWidth() * 0.5 + "px",
          });
        };
        var moveTimer = null;
        var clearTime = function () {
      ...
      volumeDragY = function () {
        ...
        var docMouseMove = function (e) {
          ...
          var vol =
            (bg.getHeight() - ppMarginTop - slider.getHeight() * 0.5) /
            (bg.getHeight() - slider.getHeight());
          player.volume(vol);
        };
        var docMouseUp = function () {
          noScrolling();
      ...
      changeProgress = function (time) {
        ...
        if (!pSliderMouseDown) {
          ...
          var sliderLeft = playW - sliderW * 0.5;
          if (sliderLeft < 0) {
            sliderLeft = 0;
          }
      ...
      checkProgressSlider = function () {
        ...
        if (C["bar"]["pbox"].css("transition-duration")) {
          st =
            parseFloat(C["bar"]["pbox"].css("transition-duration")) * 1000 + 20;
        }
      ...
      replaceInformation = function (o, n) {
        if (
          isUndefined(C["about"]["sourceData"]) &&
          !isUndefined(C["about"].find("ul"))
        ) {
      ...
      $ = function (obj, eL) {
        ...
        if (res) {
          if (
            valType(res) == "htmlobject" ||
            valType(res) == "object" ||
            valType(res) == "document"
          ) {
            ...
            res.css = function (key, value) {
              ...
              var keyNew = function (str) {
                ...
                if (str.indexOf("-") != -1) {
                  ...
                  if (arr.length > 1) {
                    b =
                      arr[1].substr(0, 1).toLocaleUpperCase() +
                      arr[1].substr(1, arr[1].length - 1);
                  }
                  if (arr.length > 2) {
                    b =
                      arr[2].substr(0, 1).toLocaleUpperCase() +
                      arr[2].substr(1, arr[2].length - 1);
                  }
                  return a + b + c;
                }
                // 没有横杠就不进行字符串拆解
            ...
            res.addClass = function (cName) {
              if (!this.hasClass(cName)) {
                if (
                  this.className &&
                  this.className.substr(this.className.length - 1, 1) != " "
                ) {
                  this.className += " ";
                }
            ...
            res.removeClass = function (cName) {
              if (this.hasClass(cName)) {
                ...
                if (
                  ...
                  this.className = this.className.substr(
                    0,
                    this.className.length - 1
                  );
                }
                if (!this.className) {
                ...
                Bounce: {
                  ...
                  easeInOut: function (t, b, c, d) {
                    if (t < d / 2) {
                      ...
                      return (
                        tween.Bounce.easeOut(t * 2 - d, 0, c, d) * 0.5 +
                        c * 0.5 +
                        b
                      );
                    }
                ...
                switch (arr[0]) {
                  ...
                  case "left":
                    if (!isUndefined(thisTemp.css("left"))) {
                      ...
                      current =
                        thisTemp.offset()["left"] - parNode.offset()["left"];
                    }
                    if (vars.substring(vars.length - 1, vars.length) == "%") {
                  ...
                  case "top":
                    if (!isUndefined(thisTemp.css("top"))) {
                      ...
                      current =
                        thisTemp.offset()["top"] - parNode.offset()["top"];
                    }
                    if (vars.substring(vars.length - 1, vars.length) == "%") {
                      result = parseInt(vars) * h * 0.01;
                    } else {
                  ...
                  case "alpha":
                    if (
                      !isUndefined(thisTemp.css("filter")) &&
                      thisTemp.css("filter") != "none"
                    ) {
                      current = Number(thisTemp.css("filter")) * 100;
                    } else if (
                      !isUndefined(thisTemp.css("opacity")) &&
                      thisTemp.css("opacity") != "none"
                    ) {
  ...
  function ajax(cObj) {
    ...
    var successFun = function (success) {
      if (
        !isUndefined(obj["success"]) &&
        valType(obj["success"]) == "function"
      ) {
        obj["success"](success);
      }
    };
  ...
  function documentReady(fn) {
    ...
    var bodyLoad = function () {
      timer = setInterval(function () {
        try {
          if (
            !isUndefined(document.readyState) &&
  ...
  function valType(val) {
    ...
    if (
      str.substr(0, 4) == "html" &&
      (str.substr(-7) == "element" ||
        str.substr(-8) == "document" ||
        str == "window")
    ) {
      str = "htmlobject";
    }
  ...
  function isUndefined(val) {
    try {
      return (
        valType(val) === "undefined" ||
        val === undefined ||
        val === null ||
        (valType(val) === "number" && isNaN(val))
      );
    } catch (event) {
      return true;
    }
  ...
  function cookie(name, value, domain, path) {
    ...
    var set = function (name, value) {
      ...
      del = function (name) {
        ...
        if (cval != null) {
          document.cookie =
            name + "=" + cval + ";expires=" + exp.toGMTString() + ckStr;
        }
      };
