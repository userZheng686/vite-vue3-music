...
import { handleCopyLink, handleNextPlaySong, handlePlaySong, handleCollectPlaylist, loginCallback } from '../utils'

//弹窗显示
let songMenu = useSongMenuPopupStore();

//专辑歌曲的右键菜单
export function contextMenuAlbum(event: MouseEvent, row: SongDetailSongsItem) {
    let list = [
        {
            label: `查看评论`,
